            ...
            .map(
                reportRecord => {
                    ...
                    return {
                        ...
                        remark:
                            reportRecord.teacher_remark ||
                            reportRecord.remark ||
                            "",

                        principal_remark:
                            reportRecord.principal_remark ||
                            "",
...
function renderReports() {
    ...
    if ($("publishedReportsMirror")) {

        $("publishedReportsMirror")
            .textContent =
...
function openReport(key) {
    ...
    if ($("reviewPrincipalRemark")) {

        if (currentReport.principal_remark) {

            $("reviewPrincipalRemark")
                .textContent =
                currentReport.principal_remark;
            ...
            $("reviewPrincipalRemark")
                .textContent =
                "No Principal remark has been submitted yet.";
